...
#   include(${CTEST_SCRIPT_DIRECTORY}/sensei_common.cmake)
#
...
set(CTEST_DROP_SITE "nersc.cdash.gov")
if(NOT dashboard_git_url)
  set(dashboard_git_url "https://github.com/scottwittenburg/sensei.git")
endif()
...
if(NOT dashboard_source_name)
  set(dashboard_source_name "SENSEI")
endif()
